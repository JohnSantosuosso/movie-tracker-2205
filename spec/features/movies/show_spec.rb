...
RSpec.describe 'Movies Show Page' do
  ...
  it "lists all actors from youngest to oldest" do
    ...
    it "sees a form to add an actor to this movie and when form is submitted it is redirected back to movie show page and actor's name appears" do
    studio_1 = Studio.create(id: 100, name: "Universal Studios", location: "Hollywood")
    studio_2 = Studio.create(id: 200, name: "Warner Brothers", location: "Burbank")
    ...
    visit "/movies/#{movie_1.id}"
      ...
      fill_in "actor_name", with: "Tom Cruise"
      fill_in "actor_age", with: "3"
      ...
      expect(page).to have_content("Average Actor Age: 30.0")
  end
end
